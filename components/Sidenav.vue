<template>
  <div
    v-if="sideNavFilters"
    ref="sidenavRef"
    class="fixed top-0 z-[80] h-screen w-96 select-none overflow-y-auto border border-gray-200 bg-white text-black md:relative md:z-0 md:h-auto"
  >
    ...
    <div class="bg-gray-200">
      <div class="flex w-[95%] flex-col bg-white">
        <div
  ...
  <div
    v-if="sideNavFilters"
    class="fixed top-0 z-[60] h-screen w-full bg-black/40"
  ></div>
</template>
...
onClickOutside(sidenavRef, () => emit("handleSideFilters"));
